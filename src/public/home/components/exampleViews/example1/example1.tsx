...
const GridContainer = styled.div`
  ...
  grid-template-columns: repeat(
    auto-fit,
    minmax(300px, 1fr)
  ); /* Ajuste automático de columnas con tamaño mínimo */
...
const Example1 = ({handleRedirectToPage}:Props) => {
  // Lista de datos para los cards
  const cardData = Array(9).fill({
    imageSrc:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSju5Ui0LFR83ddq5S1hfADGAeQwbkg5vvwbA&s",
    title: "Lenteja",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis scelerisque, neque id pellentesque laoreet, orci nisl varius velit, id luctus mi turpis ut dui. Nullam feugiat eget eros non rutrum.",
  });
